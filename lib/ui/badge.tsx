  ...
  "inline-flex items-center rounded-full border border-solid px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        critical: "bg-critical-50/10 text-critical-70 border-transparent",
        positive: "bg-positive-50/10 text-positive-70 border-transparent",
        warning: "bg-warning-50/10 text-warning-70 border-transparent",
        info: "bg-info-50/10 text-info-70 border-transparent",
