...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-f1-background-neutral-secondary p-1 text-f1-foreground-neutral-secondary",
      className
    )}
    {...props}
  />
