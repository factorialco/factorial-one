...
export function TableCell({ children, sticky = false }: TableCellProps) {
  ...
  return (
    <TableCellRoot
      className={cn({
        "relative sticky left-0 z-10 bg-f1-background before:absolute before:inset-0 before:z-[-1] before:h-full before:w-full before:bg-f1-background before:transition-all before:content-[''] group-hover:before:bg-f1-background-hover":
          sticky && isScrolled,
      })}
    >
      <AnimatePresence>
