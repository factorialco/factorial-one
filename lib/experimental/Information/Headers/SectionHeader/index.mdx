...
- Elements follow a clear hierarchy to ensure scanability and consistency in the
  user experience.
- Predictable visual alignment and logical interaction order reduce friction and
  facilitate navigation.
- Mandatory components establish the base structure, while optional ones add
  flexibility.

<img
  src="docs/headers/section-header-layout.png"
