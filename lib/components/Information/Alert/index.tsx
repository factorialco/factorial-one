...
const alertVariants = cva(
  "bg-f1-background-secondary text-f1-foreground [&>svg]:text-f1-foreground relative w-full rounded-2xl p-6 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-6 [&>svg]:top-6 [&>svg~*]:pl-8",
  {
    variants: {
      variant: {
