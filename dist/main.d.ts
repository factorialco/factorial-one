...
export declare const ActivitiesProvider: React.FC<{
    children: ReactElement;
}>;

export declare const Activity: default_2.FC<ActivityProps>;

export declare type ActivityComponent<Data extends SerializableProps> = React.FC<Data>;

export declare type ActivityDefinition<Data extends SerializableProps = Record<string, string>> = {
...
export declare type OpenActivityCallback = <Data extends SerializableProps>(activity: ActivityDefinition<Data>, args: Data, options?: {
    onClose?: () => void;
}) => void;
...
export declare type SerializableProps<T extends Record<string, string> = Record<string, string>> = T;
