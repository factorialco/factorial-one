import { C as A, L as dt, c as ft, P as Be, a as k, f as pt, b as vt, A as gt, B as mt, d as yt, e as ht, g as bt, V as wt, h as He, i as xt, j as Dt, M as We, I as Ke, F as Ct, D as Tt, k as Ot, l as Pt, m as St, n as qe, S as Et, o as Nt, p as $, U as Ue, q as At, r as jt, s as he, t as Mt, u as Ye, v as Lt, w as It, x as Ft, y as kt, z as Rt, E as $t, G as Bt, H as Ht, J as Wt, X as Kt, K as qt, N as Ut, O as Yt, Q as Vt } from "./index-DX0ti01w.js";
import { aj as qn, R as Un, ap as Yn, T as Vn, W as zn, Y as Xn, Z as Gn, _ as Jn, $ as Qn, a0 as Zn, a1 as _n, a2 as ea, a3 as ta, a4 as ra, a5 as na, a7 as aa, a8 as oa, a9 as ia, aa as la, ad as sa, ae as ua, af as ca, ag as da, ah as fa, a6 as pa, ai as va, ac as ga, am as ma, ak as ya, aq as ha, ab as ba, ar as wa, al as xa, ao as Da, an as Ca } from "./index-DX0ti01w.js";
    ...
    Ot,
    {
      ...
      children: [
        /* @__PURE__ */ D("div", { className: "flex flex-row items-center justify-between px-4 py-4", children: [
          /* @__PURE__ */ D(Pt, { className: "flex flex-row items-center gap-2 text-lg font-semibold text-f1-foreground", children: [
...
function Mn({
  ...
  const [m, y] = M(e), [O, h] = M(null), [T, w] = M(!1), b = async () => {
    if (f != null && f.onClick) {
      w(!0);
      try {
...
function Ln({
  ...
  const [O, h] = M(!1), [T, w] = M(null), [b, g] = M(null), S = (x) => {
    r(x), m && m();
  }, P = async (x) => {
    if (x.type === "upsell") {
      g(x);
  ...
  }, N = e && !O, j = v == null ? void 0 : v.map((x) => x.type === "upsell" ? {
    ...x,
    onClick: () => P(x)
  } : x);
  return /* @__PURE__ */ D(ue, { children: [
    /* @__PURE__ */ D(It, { open: N, onOpenChange: S, children: [
    ...
    (b == null ? void 0 : b.type) === "upsell" && b.showConfirmation && T && /* @__PURE__ */ u(
      Ue,
      {
        open: !0,
        onClose: E,
...
var B = /* @__PURE__ */ Or(), at = "data-pdnd-honey-pot";
function ot(e) {
...
function Ae(e) {
  var r = e.client, t = Ar(Nr(Er(Sr(r))));
...
function Zr(e) {
  ...
  function i(c) {
    var v, m, y, O, h = c.source, T = c.target, w = c.input, b = c.result, g = b === void 0 ? [] : b;
    if (T == null)
      return g;
    if (!(T instanceof Element))
      return T instanceof Node ? i({
        source: h,
    ...
    var N = (v = (m = P.getData) === null || m === void 0 ? void 0 : m.call(P, E)) !== null && v !== void 0 ? v : {}, j = (y = (O = P.getDropEffect) === null || O === void 0 ? void 0 : O.call(P, E)) !== null && y !== void 0 ? y : t, x = {
      data: N,
      element: P.element,
      dropEffect: j,
  ...
  function d(c) {
    var v = c.eventName, m = c.payload, y = ne(m.location.current.dropTargets), O;
    try {
      for (y.s(); !(O = y.n()).done; ) {
        var h, T = O.value, w = n.get(T.element), b = I(I({}, m), {}, {
          self: T
        });
  ...
  var f = {
    ...
    onDropTargetChange: function(v) {
      var m = v.payload, y = new Set(m.location.current.dropTargets.map(function(W) {
        return W.element;
      })), O = /* @__PURE__ */ new Set(), h = ne(m.location.previous.dropTargets), T;
      try {
        for (h.s(); !(T = h.n()).done; ) {
          var w, b = T.value;
          O.add(b.element);
          var g = n.get(b.element), S = y.has(b.element), P = I(I({}, m), {}, {
            self: b
          });
          if (g == null || (w = g.onDropTargetChange) === null || w === void 0 || w.call(g, P), !S) {
            var E;
  ...
  function C(c) {
    var v = c.source, m = c.target, y = c.input, O = c.current, h = i({
      source: v,
      target: m,
      input: y
    });
    if (h.length >= O.length)
      return h;
    for (var T = ae(O), w = ae(h), b = [], g = 0; g < T.length; g++) {
      var S, P = T[g], E = w[g];
      if (E != null) {
        b.push(E);
        continue;
      ...
      if (x.canDrop && !x.canDrop(R) || !((S = x.getIsSticky) !== null && S !== void 0 && S.call(x, R)))
        break;
      b.push(I(I({}, P), {}, {
        ...
        if (r.canStart(n) && !n.defaultPrevented) {
          ...
          if (m)
            for (var y = 0, O = Object.entries(m); y < O.length; y++) {
              var h = rt(O[y], 2), T = h[0], w = h[1];
              n.dataTransfer.setData(T, w ?? "");
            }
...
const pn = Ve(
  ...
  $t,
  {
    ...
    children: /* @__PURE__ */ u(Bt, { ...l, children: /* @__PURE__ */ u(Ht, { ...o, children: /* @__PURE__ */ u(Wt, { ...t, children: /* @__PURE__ */ u(vn, { ...r, children: /* @__PURE__ */ u(Kt, { children: /* @__PURE__ */ u(
      ...
      {
        initiallyEnabled: n,
        children: /* @__PURE__ */ u(Ut, { ...a, children: e })
      }
    ) }) }) }) }) })
  }
) });
