...
import { u as k, L as p, c as s, I as c, F as L, C as t, A as B, B as g, a as P, b as $, P as I, V, X as b, d as A, e as R } from "./index-CMAEE6u4.js";
import { h as Y, g as Z, f as ee } from "./index-CMAEE6u4.js";
...
const F = w("inline-flex flex-row items-center gap-1 text-base", {
  ...
  return y(() => {
    ...
    "div",
    {
      ...
      className: s({
        "flex h-screen w-screen flex-col bg-f1-background-secondary": r
      }),
      children: o
    }
  ) });
