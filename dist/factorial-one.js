import { C as v, L as ne, c as ie, P as z, a as b, f as de, b as ce, A as ue, B as fe, d as he, e as me, g as pe, V as ve, h as A, i as ge, j as be, F as U, k as xe, l as Ce, m as ye, D as we, n as Ne, o as Le, p as Pe, q as H, S as Se, r as ke, s as w, U as W, t as Fe, u as Me, v as j, w as Te, x as Y, y as De, z as Re, E as Be, G as $e, H as Ie, I as Oe, J as Ee, K as je, M as _e, X as Ve, N as qe, O as ze, Q as Ae, R as Ue } from "./hooks-DRBmZMg7.js";
import { ak as ja, T as _a, am as Va, av as qa, W as za, Y as Aa, Z as Ua, _ as Ha, $ as Wa, a0 as Ya, a1 as Ga, a2 as Xa, a4 as Ja, a5 as Ka, a6 as Qa, a7 as Za, a9 as er, aa as ar, ab as rr, ac as sr, af as tr, ag as lr, ah as or, ai as nr, a8 as ir, aj as dr, ae as cr, as as ur, al as fr, aq as hr, aw as mr, a3 as pr, ad as vr, an as gr, ao as br, ap as xr, ax as Cr, ar as yr, au as wr, at as Nr } from "./hooks-DRBmZMg7.js";
...
const xa = {
  ...
  ne
), ya = ["person", "team", "company", "file"];
var O = "Progress", E = 100, [Xe, wa] = ie(O), [Je, Ke] = Xe(O), J = I.forwardRef(
  (a, r) => {
    const {
      __scopeProgress: s,
      value: t = null,
    ...
    const n = _(l) ? l : E;
    t !== null && !V(t, n) && console.error(ea(`${t}`, "Progress"));
    const o = V(t, n) ? t : null, h = T(o) ? u(o, n) : void 0;
  ...
  function({ children: r, sideContent: s, mainColumnPosition: t = "left" }, l) {
    return /* @__PURE__ */ e("div", { ref: l, className: "h-full overflow-auto", children: /* @__PURE__ */ c(
      "div",
      {
        ...
        children: [
          t === "right" && /* @__PURE__ */ e(q, { children: s }),
          /* @__PURE__ */ e(
            "main",
            {
              className: b(
          ...
          t === "left" && /* @__PURE__ */ e(q, { children: s })
        ]
      }
    ) });
  }
), q = ({ children: a }) => /* @__PURE__ */ e("aside", { className: "py-5 pl-2 pr-4 sm:basis-1/4 sm:pb-6", children: a }), na = be({
...
}), re = He.forwardRef(({ children: a, variant: r, className: s, ...t }, l) => /* @__PURE__ */ e(A, { layout: "standard", children: /* @__PURE__ */ e(
  "section",
  {
    ref: l,
...
const Ta = v(
  ...
  /* @__PURE__ */ e(Ce, { icon: ye, size: "md", className: "text-f1-icon-positive" }),
      ...
      children: [
        /* @__PURE__ */ c("div", { className: "flex flex-row items-center justify-between px-4 py-4", children: [
          /* @__PURE__ */ c(Le, { className: "flex flex-row items-center gap-2 text-lg font-semibold text-f1-foreground", children: [
            l && /* @__PURE__ */ e(U, { module: l, size: "lg" }),
            s
          ] }),
          /* @__PURE__ */ e(
            Pe,
...
function Ba({
  ...
  const [R, k] = g(a), [C, y] = g(null), [P, m] = g(!1), F = async () => {
    if (f != null && f.onClick) {
      m(!0);
      try {
        await f.onClick(), k(!1), y("success");
      } catch {
        y("error");
      } finally {
        m(!1);
...
function ua({
  ...
  return /* @__PURE__ */ e($, { children: h ? null : /* @__PURE__ */ c(Fe, { style: { width: u }, className: "relative bg-f1-background p-1", children: [
...
function $a({
  ...
  const [k, C] = g(!1), [y, P] = g(null), [m, F] = g(null), M = (p) => {
    r(p), S && S();
  }, B = async (p) => {
    if (p.type === "upsell") {
      F(p);
    ...
    P(null), C(!1), F(null), r(!1);
  }, le = a && !k, oe = x == null ? void 0 : x.map((p) => p.type === "upsell" ? {
    ...p,
    onClick: () => B(p)
  } : p);
  return /* @__PURE__ */ c($, { children: [
...
const ha = Ge(
  ...
  children: a
}) => /* @__PURE__ */ e(Ae, { reducedMotion: "user", children: a }), Ia = ({
  children: a,
  layout: r,
  link: s,
  ...
  Oe,
  {
    ...
    children: /* @__PURE__ */ e(Ee, { ...i, children: /* @__PURE__ */ e(je, { ...u, children: /* @__PURE__ */ e(_e, { ...s, children: /* @__PURE__ */ e(ma, { ...r, children: /* @__PURE__ */ e(Ve, { children: /* @__PURE__ */ e(
      qe,
      {
        initiallyEnabled: t,
        children: /* @__PURE__ */ e(ze, { ...l, children: a })
      }
    ) }) }) }) }) })
  }
) });
export {
  ...
  Cr as useEmojiConfetti,
  yr as usePrivacyMode,
