...
import k, { forwardRef as A, createContext as _, useContext as X, useState as w, useCallback as z, useEffect as P, useRef as H, useImperativeHandle as fe } from "react";
import { Slot as me } from "@radix-ui/react-slot";
import * as p from "@radix-ui/react-dialog";
import { ChevronLeft as pe, ChevronRight as ge, ChevronDown as O, ChevronUp as xe, Check as ye, OctagonX as be, CircleCheck as ve, TriangleAlert as he, BookOpen as we, X as Ne } from "lucide-react";
import { useIsomorphicLayoutEffect as F } from "usehooks-ts";
...
const I = y(
  ...
  ({ className: e, rounded: t, variant: r, size: o, asChild: s = !1, ...l }, d) => /* @__PURE__ */ a(
    s ? me : "button",
    {
      className: n(I({ variant: r, size: o, className: e, rounded: t })),
      ref: d,
      ...l
    }
  )
...
const B = A(
  ...
  defaultVariants: {}
}), R = A(({ className: e, gap: t, children: r, ...o }, s) => /* @__PURE__ */ a(
  G,
  {
    className: n(Ae({ gap: t }), e),
    ref: s,
    ...o,
    children: r
  }
)), j = _({ enabled: !1, enable: () => null, disable: () => null, filter: [] }), Se = ({
  children: e
}) => {
  const [t, r] = w(!1), [o, s] = w([]), l = z(
    (m) => {
      s(
        m || [...L].filter((f) => f !== "layout")
      ), r(!0);
    },
    [s, r]
  ), d = z(() => r(!1), [r]);
  ...
  }, [l, d]), /* @__PURE__ */ u(j.Provider, { value: { enabled: t, enable: l, disable: d, filter: o }, children: [
    e,
      ...
      /* @__PURE__ */ u(
        R,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ a(R, { gap: "2", children: L.map((m) => /* @__PURE__ */ u("label", { className: "block", children: [
              /* @__PURE__ */ a(
                "input",
                {
  ...
  const { enabled: r, filter: o } = i.useContext(j), s = H(null);
  fe(t, () => s.current);
  const l = r && !e.internal, d = typeof document < "u" ? document.body : null;
  return P(() => {
    if (!l || !s.current || !o.includes(e.type)) return;
    const m = s.current;
    m.dataset.componentName = e.name;
    let f = null, g = null;
    if (d) {
      const S = m.getBoundingClientRect(), { top: N, left: C, width: D, height: T } = S;
      f = document.createElement("div"), f.className = De({ type: e.type }), f.style.top = `${N}px`, f.style.left = `${C}px`, f.style.width = `${D}px`, f.style.height = `${T}px`, g = document.createElement("div"), g.className = Te({ type: e.type }), g.style.top = `${N}px`, g.style.left = `${C}px`, g.innerText = e.name, d.appendChild(g), d.appendChild(f);
    }
    return () => {
...
}, vt = () => X(j), L = ["layout", "info", "action", "form"], x = (e, t) => {
  const r = A((o, s) => {
    const { ref: l } = ze(e, s);
    return /* @__PURE__ */ a(t, { ref: l, ...o });
  });
  return r.displayName = `${e.name}`, r;
}, U = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  "div",
  {
    ref: r,
    className: n(
...
const M = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  "h3",
  {
    ref: r,
    className: n(
...
const W = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a("div", { ref: r, className: n("p-6", e), ...t }));
...
const At = c.Root, St = c.Group, Dt = c.Value, _e = i.forwardRef(({ className: e, children: t, ...r }, o) => /* @__PURE__ */ u(
  c.Trigger,
  {
    ref: o,
    className: n(
    ...
    children: [
      t,
      /* @__PURE__ */ a(c.Icon, { asChild: !0, children: /* @__PURE__ */ a(O, { className: "h-4 w-4 opacity-50" }) })
    ]
  }
));
...
Q.displayName = c.ScrollUpButton.displayName;
const Z = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  c.ScrollDownButton,
  {
    ref: r,
    className: n(
    ...
    ...t,
    children: /* @__PURE__ */ a(O, { className: "h-4 w-4 text-secondary-foreground" })
  }
));
Z.displayName = c.ScrollDownButton.displayName;
...
const Fe = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  c.Separator,
  {
    ref: r,
...
Fe.displayName = c.Separator.displayName;
const Tt = x(
  {
    name: "Input",
    type: "form"
...
function Vt({ className: e, variant: t, ...r }) {
...
const Me = y("grid grid-cols-1", {
...
}), Ye = k.forwardRef(({ className: e, gap: t, children: r, tileSize: o, ...s }, l) => /* @__PURE__ */ a("div", { className: n("@container", "grow"), ref: l, ...s, children: /* @__PURE__ */ a(
  "div",
  {
...
}), Je = k.forwardRef(({ className: e, gap: t, wrap: r, ...o }, s) => /* @__PURE__ */ a(
  G,
  {
  ...
  Ye
), jt = v.Root, Ke = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  v.List,
  {
    ref: r,
    className: n(
...
const et = p.Root, Ft = p.Trigger, tt = p.Portal, Bt = p.Close, ee = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  p.Overlay,
  {
    ref: r,
    className: n(
...
ee.displayName = p.Overlay.displayName;
const te = i.forwardRef(({ className: e, children: t, ...r }, o) => /* @__PURE__ */ u(tt, { children: [
  /* @__PURE__ */ a(ee, {}),
  /* @__PURE__ */ u(
    p.Content,
    {
...
const oe = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  p.Title,
  {
    ref: r,
...
oe.displayName = p.Title.displayName;
const ne = i.forwardRef(({ className: e, ...t }, r) => /* @__PURE__ */ a(
  p.Description,
  {
    ref: r,
    className: n("text-sm text-muted-foreground", e),
...
ne.displayName = p.Description.displayName;
const at = ({ primary: e, secondary: t }) => /* @__PURE__ */ u(ae, { children: [
  t && /* @__PURE__ */ a(
    B,
    {
      variant: "secondary",
...
] }), se = k.createContext(null), Lt = () => {
  const e = k.useContext(se);
  if (!e)
    ...
    se.Provider,
    {
      ...
      children: /* @__PURE__ */ a(
        et,
        {
          ...
          children: /* @__PURE__ */ a(te, { children: t.element })
        }
      )
    }
  );
  ...
  return e;
}, le = i.forwardRef(({ className: e, children: t, ...r }, o) => /* @__PURE__ */ u(
  b.Root,
  {
    ref: o,
    ...
    children: [
      ...
      /* @__PURE__ */ a(V, { orientation: "vertical" }),
      /* @__PURE__ */ a(V, { orientation: "horizontal" }),
      /* @__PURE__ */ a(b.Corner, {})
    ]
  }
));
le.displayName = b.Root.displayName;
const V = i.forwardRef(({ className: e, orientation: t = "vertical", ...r }, o) => /* @__PURE__ */ a(
...
V.displayName = b.ScrollAreaScrollbar.displayName;
const Ot = x(
  {
    name: "ScrollArea",
    type: "layout"
  ...
  const o = H(null), [s, l] = w(o.current);
  return F(() => {
    l(o.current);
  }, []), F(() => {
...
}, Et = ({ children: e, layout: t, activity: r }) => /* @__PURE__ */ a(lt, { ...t, children: /* @__PURE__ */ a(st, { ...r, children: /* @__PURE__ */ a(Se, { children: e }) }) });
export {
