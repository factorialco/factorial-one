...
declare type DateGroup = "today" | "yesterday" | "lastWeek" | "lastMonth" | number;
...
export declare function UpsellingButton({ label, showIcon, onRequest, showConfirmation, loading: externalLoading, errorMessage, successMessage, loadingState, nextSteps, closeLabel, variant, onModalStateChange, ...props }: UpsellingButtonProps): JSX_2.Element;
