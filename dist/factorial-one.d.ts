...
declare type Action = UpsellAction | RegularAction;
...
declare type Action_3 = UpsellAction_2 | RegularAction_2;
...
export declare const ProductBlankslate: {
    ({ backgroundImage, icon, title, description, isVisible, actions, }: ProductBlankslateProps): JSX_2.Element | null;
    displayName: string;
};

export declare const ProductBlankslateModal: ForwardRefExoticComponent<ProductBlankslateModalProps & RefAttributes<HTMLDivElement>>;

declare type ProductBlankslateModalProps = {
    title: string;
    subtitle?: string;
    image: string;
    benefits: string[];
...
export declare type ProductBlankslateProps = {
...
declare type RegularAction_2 = BaseAction_2 & {
    type: "regular";
    variant: ButtonVariant;
};
...
declare type UpsellAction_2 = BaseAction_2 & {
    type: "upsell";
    errorMessage: ErrorMessageProps;
    successMessage: SuccessMessageProps;
    loadingState: LoadingStateProps;
