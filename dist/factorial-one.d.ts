...
export declare type F0TextProps = Omit<TextInternalProps, (typeof privateProps_3)[number]> & {
    variant?: Exclude<TextInternalProps["variant"], (typeof _privateVariants)[number]>;
};
...
declare const privateProps_3: readonly ["className"];

declare const _privateVariants: readonly ["selected", "heading-large", "label-input", "warning", "critical", "positive", "info", "warning-strong", "critical-strong", "positive-strong", "info-strong"];
...
declare interface TextInternalProps extends Omit<default_2.HTMLAttributes<HTMLElement>, "className">, default_2.RefAttributes<HTMLElement> {
    /**
