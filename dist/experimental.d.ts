 ...
 */
export declare const useDataSource: <Record extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, Actions extends ActionsDefinition<Record>>({ currentFilters: initialCurrentFilters, filters, ...rest }: DataSourceDefinition<Record, Filters, Sortings, Actions>, deps?: ReadonlyArray<unknown>) => DataSource<Record, Filters, Sortings, Actions>;
