...
export declare const BlankTextEditor: ForwardRefExoticComponent<BlankTextEditorProps & RefAttributes<BlankTextEditorHandle>>;

export declare type BlankTextEditorHandle = {
    clear: () => void;
    focus: () => void;
...
declare interface ToolbarLabels {
    bold: string;
    italic: string;
    underline: string;
    strike: string;
