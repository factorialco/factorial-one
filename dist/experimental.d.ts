...
declare type AvatarNamedEntity = {
    id: number;
    name: string;
    avatar?: string;
    expanded?: boolean;
...
declare type AvatarNamedGroup = {
    value: string;
    label: string;
};

declare type AvatarNamedSubEntity = {
    subId: number;
    subName: string;
    subAvatar?: string;
};

export declare const AvatarNameSelector: ({ entities, groups, onGroupChange, placeholder, selectedGroup, searchPlaceholder, selectAllLabel, clearLabel, selectedLabel, }: AvatarNameSelectorProps) => JSX_2.Element;

declare interface AvatarNameSelectorProps {
...
export declare function ClockInControls({ remainingMinutes, data, labels, locationId, locations, canShowLocation, locationSelectorDisabled, onClockIn, onClockOut, onBreak, canShowBreakButton, onChangeLocationId, }: ClockInControlsProps): JSX_2.Element;
 ...
 */
export declare type CollectionProps<Record extends RecordType, Filters extends FiltersDefinition, VisualizationOptions extends object> = {
 ...
 * @template Filters - The available filter configurations for the collection
 */
declare type DataAdapter<Record extends RecordType, Filters extends FiltersDefinition> = {
 ...
 */
export declare const DataCollection: <Record extends RecordType, Filters extends FiltersDefinition>({ source, visualizations, }: {
    source: DataSource<Record, Filters>;
 ...
 * @template Filters - The available filter configurations for the collection
 */
export declare type DataSource<Record extends RecordType, Filters extends FiltersDefinition> = DataSourceDefinition<Record, Filters> & {
 ...
 * @template Filters - The available filter configurations for the collection
 */
export declare type DataSourceDefinition<Record extends RecordType, Filters extends FiltersDefinition> = {
 ...
 */
export declare type DataSourceResult<T> = PromiseOrObservable<{
    records: Array<T>;
}>;
 ...
 * ```
 */
export declare function Filters<Definition extends FiltersDefinition>({ schema, filters: value, onChange, }: FiltersProps<Definition>): JSX_2.Element;
 ...
 */
declare type PromiseOrObservable<T> = Promise<T> | Observable<T>;
 ...
 */
export declare const useDataSource: <Record extends RecordType, Filters extends FiltersDefinition>({ filters, currentFilters: initialCurrentFilters, dataAdapter, }: DataSourceDefinition<Record, Filters>, deps?: ReadonlyArray<unknown>) => DataSource<Record, Filters>;
 ...
 */
declare type Visualization<Record extends RecordType, Filters extends FiltersDefinition> = {
