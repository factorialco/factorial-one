...
export declare const ActivityItemList: (({ items, onClickItem, onEndReached, onEndReachedItemsThreshold, }: ActivityItemListProps) => default_2.JSX.Element) & {
...
export declare const BaseActivityItemList: ({ items, onClickItem, onEndReached, onEndReachedItemsThreshold, }: ActivityItemListProps) => default_2.JSX.Element;
...
declare type GranularityDefinitionSimple = Pick<GranularityDefinition, "toRangeString">;
