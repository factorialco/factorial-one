...
export declare const ChartWidgetEmptyState: ForwardRefExoticComponent<Props_11 & RefAttributes<HTMLDivElement>>;

export declare type ChatWidgetEmptyStateProps = Props_11;
...
declare type Props_13<Id extends string | number = string | number> = {
    id: Id;
    module?: ModuleId;
    title: string;
    subtitle: string;
...
declare type Props_14<Id extends string | number = string | number> = {
...
declare const PulseAvatar: {
    ({ firstName, lastName, src, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledby, pulse, onPulseClick, }: Props_10): JSX_2.Element;
    displayName: string;
};
...
export declare function WidgetHighlightButton({ label, count, icon, iconClassName, onClick, }: Props_12): JSX_2.Element;

export declare function WidgetInboxList({ items, minSize, onClickItem, showAllItems, onVisibleItemsChange, }: Props_14): JSX_2.Element;

export declare function WidgetInboxListItem({ id, title, subtitle, onClick, module, }: Props_13): JSX_2.Element;

export declare type WidgetInboxListItemProps<Id extends string | number = string | number> = Props_13<Id>;

export declare type WidgetInboxListProps = Props_14;
...
export declare function WidgetSimpleList({ items, gap, minSize, onClickItem, showAllItems, }: Props_15): JSX_2.Element;
...
export declare type WidgetSimpleListProps = Props_15;
