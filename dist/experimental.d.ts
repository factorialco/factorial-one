...
export declare const BaseCommunityPost: ({ id, author, group, createdAt, title, description, onClick, imageUrl, event, counters, reactions, inLabel, comment, dropdownItems, }: CommunityPostProps) => JSX_2.Element;

declare function BaseHeader({ title, avatar, description, eyebrow, primaryAction, secondaryActions, otherActions, status, metadata, }: BaseHeaderProps_2): JSX_2.Element;
...
export declare function ClockInControls({ remainingMinutes, data, labels, onClockIn, onClockOut, onBreak, collapsed, }: ClockInControlsProps): JSX_2.Element;
...
export declare const CommunityPost: (({ id, author, group, createdAt, title, description, onClick, imageUrl, event, counters, reactions, inLabel, comment, dropdownItems, }: CommunityPostProps) => JSX_2.Element) & {
...
export declare const CompanyHeader: ({ name, description, src, primaryAction, secondaryActions, otherActions, metadata, status, }: Props_6) => JSX_2.Element;
...
export declare const PersonHeader: ({ firstName, lastName, description, src, primaryAction, secondaryActions, otherActions, metadata, status, }: Props_7) => JSX_2.Element;
...
declare type Props_6 = {
    ...
    description: string;
    src?: string;
} & Pick<BaseHeaderProps, "primaryAction" | "secondaryActions" | "otherActions" | "metadata" | "status">;
...
declare type Props_7 = {
    ...
    description: string;
    src?: string;
} & Pick<BaseHeaderProps_3, "primaryAction" | "secondaryActions" | "otherActions" | "metadata" | "status">;

declare type Props_8 = {} & Pick<BaseHeaderProps_4, "title" | "description" | "primaryAction" | "secondaryActions" | "otherActions" | "metadata" | "status">;
...
export declare const ResourceHeader: ({ title, description, primaryAction, secondaryActions, otherActions, status, metadata, }: Props_8) => JSX_2.Element;
