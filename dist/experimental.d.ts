...
export declare const AvatarList: {
    ({ avatars, size, type, showTooltip, }: Props_5): JSX_2.Element;
    displayName: string;
};
...
export declare const BaseCommunityPost: ({ id, author, group, createdAt, title, description, onClick, mediaUrl, event, counters, reactions, inLabel, comment, dropdownItems, }: CommunityPostProps) => JSX_2.Element;
...
export declare type BreadcrumbBaseItemType = {
    id: string;
    loading?: boolean;
};

export declare type BreadcrumbItemType = BreadcrumbLoadingItemType | BreadcrumbItemTypeText | BreadcrumbSelectItemType;

export declare type BreadcrumbItemTypeText = BreadcrumbBaseItemType & (NavigationItem & {
    icon?: IconType;
});
...
export declare function ClockInControls({ remainingMinutes, data, labels, locationId, locations, canShowProject, canShowLocation, locationSelectorDisabled, projectSelectorDisabled, projectName, onClockIn, onClockOut, onBreak, canShowBreakButton, onClickProjectSelector, onChangeLocationId, }: ClockInControlsProps): JSX_2.Element;
...
export declare const CommunityPost: (({ id, author, group, createdAt, title, description, onClick, mediaUrl, event, counters, reactions, inLabel, comment, dropdownItems, }: CommunityPostProps) => JSX_2.Element) & {
