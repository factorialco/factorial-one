...
export declare function WidgetInboxList({ items, minSize, onClickItem, showAllItems, onVisibleItemsChange, }: Props_20): JSX_2.Element;

export declare function WidgetInboxListItem({ id, title, subtitle, onClick, module, }: Props_19): JSX_2.Element;
