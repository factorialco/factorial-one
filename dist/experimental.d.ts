 ...
 */
export declare type CollectionProps<Record extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, ItemActions extends ItemActionsDefinition<Record>, VisualizationOptions extends object, Grouping extends GroupingDefinition<Record>> = {
 ...
 * @template ItemActions - The available actions that can be performed on records
 */
export declare type DataSource<Record extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, ItemActions extends ItemActionsDefinition<Record>, Grouping extends GroupingDefinition<Record>> = DataSourceDefinition<Record, Filters, Sortings, ItemActions, Grouping> & {
 ...
 */
export declare type DataSourceDefinition<Record extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, ItemActions extends ItemActionsDefinition<Record>, Grouping extends GroupingDefinition<Record>> = {
 ...
 */
export declare const OneDataCollection: <Record extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, ItemActions extends ItemActionsDefinition<Record>, Grouping extends GroupingDefinition<Record>>({ source, visualizations, onSelectItems, onBulkAction, }: {
    source: DataSource<Record, Filters, Sortings, ItemActions, Grouping>;
    visualizations: ReadonlyArray<Visualization<Record, Filters, Sortings, ItemActions, Grouping>>;
    onSelectItems?: OnSelectItemsCallback<Record, Filters>;
 ...
 */
export declare const useDataSource: <Record extends RecordType, FiltersSchema extends FiltersDefinition, Sortings extends SortingsDefinition, ItemActions extends ItemActionsDefinition<Record>, Grouping extends GroupingDefinition<Record>>({ currentFilters: initialCurrentFilters, currentGrouping: initialCurrentGrouping, filters, search, defaultSorting, dataAdapter, grouping, ...rest }: DataSourceDefinition<Record, FiltersSchema, Sortings, ItemActions, Grouping>, deps?: ReadonlyArray<unknown>) => DataSource<Record, FiltersSchema, Sortings, ItemActions, Grouping>;
 ...
 */
declare type Visualization<Record extends RecordType, Filters extends FiltersDefinition, Sortings extends SortingsDefinition, ItemActions extends ItemActionsDefinition<Record>, Grouping extends GroupingDefinition<Record>> = {
 ...
 */
declare type VisualizationType = Visualization<any, any, any, any, any>["type"];
