...
declare type AvatarVariant = DistributiveOmit<AvatarVariantWithSize, "size">;

declare type AvatarVariantWithSize = ({
    type: "person";
} & PersonAvatarProps) | ({
    type: "team";
} & TeamAvatarProps) | ({
...
declare const F0AvatarFile: ForwardRefExoticComponent<Omit<Omit<Omit<AvatarProps & RefAttributes<HTMLSpanElement>, "ref"> & {
size?: (typeof sizes)[number];
type?: type_2[number];
color?: color_2[number];
...
declare type F0AvatarFileSize = Extract<(typeof sizes)[number], "small" | "medium" | "large">;
...
declare type FileAvatarProps = ComponentProps<typeof F0AvatarFile>;
