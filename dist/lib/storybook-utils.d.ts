...
export declare const Placeholder: React.ForwardRefExoticComponent<React.HTMLAttributes<HTMLDivElement> & import('class-variance-authority').VariantProps<(props?: ({
