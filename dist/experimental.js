import { c, i as _, F as n0, I as B, j as o1, C as m, k as W, g as H, L as D, l as i0, u as f1, T as s0, m as c0, n as d0, o as f0, h as h1, A as h0, B as v0, b as u0, P as g0, V as w0, a as p0 } from "./index-BANSVCoN.js";
...
import { useForm as Ln } from "react-hook-form";
...
const Z = h.forwardRef(({ className: l, children: a, ...o }, n) => /* @__PURE__ */ t(
  z.Root,
  {
    ref: n,
...
const E = h.forwardRef(({ className: l, orientation: a = "vertical", ...o }, n) => /* @__PURE__ */ e(
...
function t1(l, { maxDecimals: a }) {
  ...
  if (!o) return null;
  let [n, i, s, d, v] = o;
  a && ((v == null ? void 0 : v.length) ?? 0) > a ? v = v == null ? void 0 : v.slice(0, a) : a === 0 && (v = ""), s = (s == null ? void 0 : s.replace(/^0+(\d)/, (p, C) => C)) ?? "";
  const f = `${i}${s}${a !== 0 ? `${d ?? ""}${v ?? ""}` : ""}`, u = parseFloat(f.replace(",", "."));
  return {
    formattedValue: f,
...
const L = (l, a, o) => new Intl.NumberFormat(a, {
  ...
  function({ locale: a, value: o, maxDecimals: n, step: i, min: s, max: d, onChange: v, ...f }, u) {
    const [p, C] = k(
      () => o != null ? L(o, a, n) : ""
    ), b = (x) => {
      const N = t1(x, { maxDecimals: n });
      if (!N) return;
      ...
      if (!i) return;
      if (o == null)
        return b(L(i ?? s ?? 0, a, n));
      const N = x === "increase" ? o + i : o - i;
      s != null && N < s || d != null && N > d || b(L(N, a, n));
    }, j = () => i ? /* @__PURE__ */ t(
      "div",
      {
    ...
    return v1(() => {
      const x = t1(p, { maxDecimals: n });
      o === void 0 || o == (x == null ? void 0 : x.value) || C(o ? L(o, a, n) : "");
    }, [p, n, o, a]), /* @__PURE__ */ t("div", { className: "group relative", children: [
      /* @__PURE__ */ e(
        Q,
        {
          type: "text",
...
const Ft = w.Root, zt = w.Value, H1 = h.forwardRef(({ className: l, children: a, ...o }, n) => /* @__PURE__ */ e(w.Trigger, { ref: n, className: c(l), ...o, children: a }));
H1.displayName = w.Trigger.displayName;
const k1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  w.ScrollUpButton,
  {
    ref: o,
    className: c(
...
const $1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  w.ScrollDownButton,
  {
    ref: o,
    className: c(
...
const V1 = h.forwardRef(({ className: l, children: a, position: o = "popper", ...n }, i) => /* @__PURE__ */ e(w.Portal, { children: /* @__PURE__ */ t(
  w.Content,
  {
    ref: i,
    className: c(
...
const At = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  w.Label,
  {
    ref: o,
...
const L1 = h.forwardRef(({ className: l, children: a, ...o }, n) => /* @__PURE__ */ t(
  w.Item,
  {
    ref: n,
    className: c(
...
const Nt = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  w.Separator,
  {
    ref: o,
  ...
  function({
    ...
    return /* @__PURE__ */ t(
      Ft,
      {
        ...
        ...u,
        children: [
          /* @__PURE__ */ e(H1, { ref: p, asChild: !0, children: s || /* @__PURE__ */ t(
            "button",
            {
              className: c(
                $t,
              ...
              children: [
                /* @__PURE__ */ e(zt, { placeholder: a, asChild: !0, children: C && /* @__PURE__ */ e(kt, { item: C }) }),
          ...
          /* @__PURE__ */ e(V1, { children: o.map((b) => /* @__PURE__ */ e(Ht, { item: b }, b.value)) })
        ]
      }
    );
  }
...
), rn = r(function({ title: a, details: o }, n) {
...
const on = m(
  ...
  It
), Dt = g.Root, Pt = g.Trigger, Ut = h.forwardRef(({ className: l, inset: a, children: o, ...n }, i) => /* @__PURE__ */ t(
  g.SubTrigger,
  {
    ref: i,
    className: c(
...
const jt = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  g.SubContent,
  {
    ref: o,
    className: c(
...
const T1 = h.forwardRef(({ className: l, sideOffset: a = 4, ...o }, n) => /* @__PURE__ */ e(g.Portal, { children: /* @__PURE__ */ e(
  g.Content,
  {
    ref: n,
    sideOffset: a,
...
const G1 = h.forwardRef(({ className: l, inset: a, ...o }, n) => /* @__PURE__ */ e(
  g.Item,
  {
    ref: n,
    className: c(
...
const Et = h.forwardRef(({ className: l, children: a, checked: o, ...n }, i) => /* @__PURE__ */ t(
  g.CheckboxItem,
  {
    ref: i,
    className: c(
...
const Wt = h.forwardRef(({ className: l, children: a, ...o }, n) => /* @__PURE__ */ t(
  g.RadioItem,
  {
    ref: n,
    className: c(
...
const qt = h.forwardRef(({ className: l, inset: a, ...o }, n) => /* @__PURE__ */ e(
  g.Label,
  {
    ref: n,
    className: c(
...
const Zt = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  g.Separator,
  {
    ref: o,
    className: c("-mx-1 my-1 h-px bg-f1-background-secondary", l),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ e(
              W,
              {
                alt: (v = d == null ? void 0 : d.name) == null ? void 0 : v[0],
...
function cn({ header: l, body: a, footer: o }) {
...
function dn({ name: l, avatarUrl: a, avatarAlt: o, options: n }) {
...
), D1 = h.forwardRef(({ className: l, children: a, secondary: o, ...n }, i) => {
  const s = m0();
  return /* @__PURE__ */ e(
    T.Root,
    {
...
const f3 = y(
  ...
  ({ asChild: l, disabled: a, active: o, className: n, children: i, secondary: s, ...d }, v) => /* @__PURE__ */ e(T.Item, { className: "flex", children: /* @__PURE__ */ e(
    T.Link,
    {
...
function fn({ tabs: l, secondary: a = !1 }) {
  const { isActive: o } = f1();
...
const h3 = S.Root, v3 = S.Portal, U1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  S.Overlay,
  {
    ref: o,
    className: c(
...
U1.displayName = S.Overlay.displayName;
const j1 = h.forwardRef(({ className: l, children: a, ...o }, n) => /* @__PURE__ */ e(v3, { children: /* @__PURE__ */ e(U1, { className: "grid place-items-center overflow-y-auto sm:p-8", children: /* @__PURE__ */ t(
  S.Content,
  {
    ref: n,
    ...
    children: [
      a,
      /* @__PURE__ */ t(S.Close, { className: "ring-offset-background focus:ring-ring absolute right-2 top-2 rounded-2xs p-2 text-f1-foreground opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-f1-background-secondary data-[state=open]:text-f1-foreground-secondary", children: [
...
j1.displayName = S.Content.displayName;
const E1 = ({
  className: l,
  ...a
}) => /* @__PURE__ */ e(
...
const Z1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  S.Title,
  {
    ref: o,
...
Z1.displayName = S.Title.displayName;
const Q1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  S.Description,
  {
    ref: o,
...
Q1.displayName = S.Description.displayName;
function G({
  className: l,
  ...a
}) {
...
), X = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  "div",
  {
    ref: o,
    className: c(
...
X.displayName = "Card";
const Y = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  "div",
  {
    ref: o,
...
const J = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e("h3", { ref: o, className: c("text-base font-medium", l), ...a }));
J.displayName = "CardTitle";
const e1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e(
  "h3",
  {
    ref: o,
    className: c(
...
const J1 = h.forwardRef(({ className: l, content: a }, o) => /* @__PURE__ */ e(
  "div",
  {
    ref: o,
...
const e0 = h.forwardRef(({ className: l, title: a, ...o }) => /* @__PURE__ */ e(
  D,
  {
    className: c(
...
const a1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e("div", { ref: o, className: c("flex grow flex-col", l), ...a }));
a1.displayName = "CardContent";
const l1 = h.forwardRef(({ className: l, ...a }, o) => /* @__PURE__ */ e("div", { ref: o, className: c("flex items-center", l), ...a }));
l1.displayName = "CardFooter";
const M3 = h.forwardRef(function({ className: a, ...o }, n) {
  return /* @__PURE__ */ e(
    "div",
    {
      ref: n,
...
const S3 = r(
  ...
  const v = (f) => !!f && !(F.isValidElement(f) && f.type === F.Fragment && F.Children.count(f.props.children) === 0);
  return /* @__PURE__ */ t(X, { className: "flex gap-4", ref: d, children: [
    ...
    /* @__PURE__ */ t(a1, { className: "flex flex-col gap-4", children: [
      ...
      F.Children.toArray(n).filter(v).map((f, u) => /* @__PURE__ */ t(I, { children: [
  ...
  r(
    function(a, o) {
      return /* @__PURE__ */ e(M, { ref: o, ...a, chart: null });
    }
  ),
  M.Skeleton
), k3 = R(
...
function Rn({
  ...
  const s = [
    ...
    ({ key: v, status: f }) => ((l == null ? void 0 : l[v]) || []).map((u) => ({
      title: u,
      status: f
    }))
  ), d = !s.length;
  return /* @__PURE__ */ e("div", { className: "flex flex-col gap-3", children: d ? /* @__PURE__ */ e("p", { className: "font-medium", children: n }) : s.slice(0, o).map((v, f) => /* @__PURE__ */ e(
    I3,
    {
      title: v.title,
      status: v.status,
...
), T3 = h.forwardRef(({ className: l, variant: a, size: o, ...n }, i) => /* @__PURE__ */ e(
  w1.Root,
  {
    ref: i,
...
const l0 = h.createContext({
  size: "default",
  variant: "default"
}), r0 = h.forwardRef(({ className: l, variant: a, size: o, children: n, ...i }, s) => /* @__PURE__ */ e(
  P.Root,
  {
    ref: s,
...
const o0 = h.forwardRef(({ className: l, children: a, variant: o, size: n, ...i }, s) => {
  const d = h.useContext(l0);
  return /* @__PURE__ */ e(
    P.Item,
    {
      ref: s,
...
const G3 = [
...
), D3 = { sm: 340, md: 480, lg: 640 }, c1 = r(
  function({ children: a, widgetWidth: o = "sm" }, n) {
    const i = D3[o], [s, d] = k(), v = x0.toArray(a), f = C0(null);
    return v1(() => {
      const u = () => {
        var C;
        const p = (C = f.current) == null ? void 0 : C.offsetWidth;
        p && d(Math.floor(p / i) || 1);
      };
      return u(), window.addEventListener("resize", u), () => {
        window.removeEventListener("resize", u);
      };
    }, [d, i]), /* @__PURE__ */ e("div", { ref: n, className: "text-f1-foreground", children: /* @__PURE__ */ e("div", { ref: f, children: s === 1 ? /* @__PURE__ */ e("div", { className: "flex flex-col gap-4 *:shadow", children: a }) : s && s > 1 && /* @__PURE__ */ e("div", { className: "relative -mr-4", children: /* @__PURE__ */ e(A0, { children: v.map((u, p) => /* @__PURE__ */ e(
      "div",
      {
        style: {
...
), P3 = ["sm", "lg", "md", "md", "lg", "sm", "lg", "lg", "sm", "sm", "md", "md"], An = R(c1, () => /* @__PURE__ */ e(Y1, { children: /* @__PURE__ */ e(c1, { children: P3.map((l, a) => /* @__PURE__ */ e(A.Skeleton, { height: l }, a)) }) })), d1 = ({ children: l }) => /* @__PURE__ */ e(
  "div",
  {
    className: c(
...
), U3 = (l, a) => /* @__PURE__ */ t("svg", { width: "192", height: "192", viewBox: "0 0 192 192", fill: "none", ref: a, ...l, xmlns: "http://www.w3.org/2000/svg", children: [
  ...
  function({ title: a, content: o, icon: n, buttonLabel: i, buttonAction: s, promote: d = !1 }, v) {
    const f = E3[n];
    return /* @__PURE__ */ e(
      A,
      {
...
export {
  wn as AreaChartWidget,
  gn as AutoGrid,
  pn as BarChartWidget,
  _t as Calendar,
  Sn as CategoryBarSection,
  An as Dashboard,
  Ot as DetailsItem,
  rn as DetailsItemsList,
  hn as Dialog,
  bn as EventsList,
  L3 as IconText,
  yn as IconTextsList,
  Bn as IndicatorsList,
  on as InfoPaneLayout,
  an as Input,
  mn as LineChartWidget,
  nn as Menu,
  ln as NumberInput,
  xn as PieChartWidget,
  kn as ScrollArea,
  sn as SearchBar,
  Vt as Select,
  cn as Sidebar,
  ...
  un as Split,
  vn as Stack,
  Mn as SummariesWidget,
  fn as Tabs,
  Gt as TagsList,
  Rn as TasksList,
  en as Textarea,
  _n as TimeStatus,
  Fn as TwoColumnsList,
  dn as User,
  Cn as VerticalBarChartWidget,
  Lt as VerticalSeparator,
  zn as Weekdays,
  A as Widget,
  Hn as WidgetEmptyState,
  Nn as WidgetStrip,
  Ln as useForm
};
