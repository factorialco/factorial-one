  ...
  return (
    <div className="-m-4 bg-secondary/60 min-h-screen h-screen p-3">
        ...
        <ResizablePanelGroup direction="horizontal">
            <ResizablePanel defaultSize={15} minSize={5} maxSize={20} collapsible>
                <ScrollArea className="h-full hidden flex-col pr-3 md:flex">
                    <div className="flex h-14 items-center gap-2 text-secondary-foreground font-medium px-3">
                        <Target size="20" />
                        <span className="truncate ...">Cool Company</span>
                    </div>
                    <nav className="flex flex-col pt-3">
                        ...
                        <div className="bg-secondary h-9 flex gap-2 items-center rounded-lg text-sm text-foreground font-medium p-1.5 truncate ... transition-colors hover:bg-secondary-intermediate/50 hover:cursor-pointer">
            ...
            <ResizableHandle className="bg-transparent data[resize-handle-state=hover]:bg-black" />
