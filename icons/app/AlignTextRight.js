...
const SvgAlignTextRight = (props, ref) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" ref={ref} {...props}>
    ...
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M13 16H19" vectorEffect="non-scaling-stroke"/>
  </svg>);
