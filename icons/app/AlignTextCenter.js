...
const SvgAlignTextCenter = (props, ref) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" ref={ref} {...props}>
    ...
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M9 16L15 16" vectorEffect="non-scaling-stroke"/>
  </svg>);
