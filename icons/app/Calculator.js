...
const SvgCalculator = (props, ref) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" ref={ref} {...props}>
    <rect width={12} height={16} x={6} y={4} stroke="currentColor" rx={3} vectorEffect="non-scaling-stroke"/>
