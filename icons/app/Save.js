...
const SvgSave = (props, ref) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" ref={ref} {...props}>
    ...
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M15 6V10H9V6" vectorEffect="non-scaling-stroke"/>
  </svg>);
