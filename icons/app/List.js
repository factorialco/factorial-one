...
const SvgList = (props, ref) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" ref={ref} {...props}>
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M9 8H19" vectorEffect="non-scaling-stroke"/>
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M9 12H19" vectorEffect="non-scaling-stroke"/>
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" d="M9 16H19" vectorEffect="non-scaling-stroke"/>
