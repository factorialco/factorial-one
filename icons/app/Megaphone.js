...
const SvgMegaphone = (props, ref) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" ref={ref} {...props}>
    ...
    <path stroke="currentColor" strokeLinecap="round" d="M20 10V14" vectorEffect="non-scaling-stroke"/>
  </svg>);
