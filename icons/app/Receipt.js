...
const SvgReceipt = (props, ref) => (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" ref={ref} {...props}>
    ...
    <path stroke="currentColor" strokeLinecap="round" d="M9 8H15" vectorEffect="non-scaling-stroke"/>
    <path stroke="currentColor" strokeLinecap="round" d="M9 12H13" vectorEffect="non-scaling-stroke"/>
  </svg>);
