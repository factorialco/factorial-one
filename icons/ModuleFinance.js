...
const SvgModuleFinance = (props, ref) => React.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", fill: "none", viewBox: "0 0 24 26", ref: ref, ...props },
    ...
    React.createElement("defs", null,
        React.createElement("filter", { id: "ModuleFinance_svg__a", width: 20.346, height: 24.549, x: 1.827, y: 1.312, colorInterpolationFilters: "sRGB", filterUnits: "userSpaceOnUse" },
            ...
            React.createElement("feBlend", { in2: "BackgroundImageFix", result: "effect1_dropShadow_6_236" }),
            React.createElement("feBlend", { in: "SourceGraphic", in2: "effect1_dropShadow_6_236", result: "shape" }))));
const ForwardRef = forwardRef(SvgModuleFinance);
