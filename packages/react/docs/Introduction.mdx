...
# Welcome to F0 <small>(read as "Factorial Zero" [/fækˈtɔːriəl ˈzɪə.roʊ/](https://ipa-reader.com/?text=f%C3%A6k%CB%88t%C9%94%CB%90ri%C9%99l%20%CB%88z%C9%AA%C9%99.ro%CA%8A))</small>

Here you can find all the guides and resources to design and develop with F0.
...
**F0** represents a transformative reboot of the visual language for the
