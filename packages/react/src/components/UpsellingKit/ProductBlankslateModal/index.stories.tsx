...
import { ProductBlankslateModal } from "."
import { UpsellingButton } from "../UpsellingButton"

const meta: Meta<typeof ProductBlankslateModal> = {
  title: "UpsellingKit/ProductBlankslateModal",
  component: ProductBlankslateModal,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
...
type Story = StoryObj<typeof ProductBlankslateModal>
