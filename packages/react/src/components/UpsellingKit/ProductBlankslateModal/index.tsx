// packages/react/src/experimental/ProductBlankslateModal/index.tsx
...
type ProductBlankslateModalProps = {
  title: string
  subtitle?: string
  image: string
  benefits: string[]
...
export const ProductBlankslateModal = forwardRef<
  HTMLDivElement,
  ProductBlankslateModalProps
>(
  (
...
ProductBlankslateModal.displayName = "ProductBlankslateModal"
