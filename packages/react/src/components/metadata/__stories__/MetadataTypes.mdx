...
import * as DataCollectionStories from "../../../experimental/OneDataCollection/__stories__/index.stories"
import * as ActionDataCollectionStories from "../../../experimental/OneDataCollection/__stories__/collection-actions.stories"
import * as CellTypesDataCollectionStories from "./MetadataTypes.stories"
...
<Canvas
  of={CellTypesDataCollectionStories.NumberValueInputAsObjectWithDecimals}
  source={{
    code: `
render: (item) => ({
    type: 'number'
...
<Canvas
  of={CellTypesDataCollectionStories.NumberValueInputAsObjectWithUnits}
  source={{
    code: `
render: (item) => ({
    type: 'number'
...
of={CellTypesDataCollectionStories.AmountWithCurrency} source={{
    code: `
render: (item) => ({
    type: 'amount'
...
of={CellTypesDataCollectionStories.AmountWithCurrencyEuro} source={{
    code: `
render: (item) => ({
    type: 'amount'
...
<Canvas
  of={CellTypesDataCollectionStories.FileType}
  source={{
    code: `
render: (item) => ({
    type: 'file',
...
<Canvas
  of={CellTypesDataCollectionStories.FolderType}
  source={{
    code: `
render: (item) => ({
    type: 'file',
