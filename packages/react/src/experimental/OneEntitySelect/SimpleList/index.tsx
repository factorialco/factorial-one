...
import { SimpleListVisualizationOptions } from "./types"

/**
 * Group SimpleList: Renders the list for a group
 */
export type SimpleListCollectionProps<
...
> = CollectionProps<
  ...
  NavigationFilters,
  Grouping,
  SimpleListVisualizationOptions<Record, Filters, Sortings>
>

export const SimpleListCollection = <
  Record extends RecordType,
  Filters extends FiltersDefinition,
  Sortings extends SortingsDefinition,
  ItemActions extends ItemActionsDefinition<Record>,
