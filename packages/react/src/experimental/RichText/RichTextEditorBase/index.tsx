...
const RichTextEditorBase = forwardRef<
...
>(function RichTextEditor(
  ...
  const editor = useEditor(
    {
      ...
      onUpdate: ({ editor }) => {
        handleEditorUpdate({ editor, onChange, setEditorState, isPlainText })
      },
    },
    [isFullscreen]
  )
  ...
  useImperativeHandle(ref, () => ({
    ...
    getContent: () =>
      (isPlainText ? editor?.getText() : editor?.getHTML()) || "",
  }))
