...
of={CellTypesDataCollectionStories.AmountWithSymbol} source={{
    code: `
render: (item) => ({
    type: 'amount'
    value: { amount: 1234, symbol: '$', symbolPosition: 'left' },
  }
})
`,
  }} />
...
of={CellTypesDataCollectionStories.AmountWithSymbolRight} source={{
    code: `
render: (item) => ({
    type: 'amount'
    value: { amount: 1234, symbol: '€', symbolPosition: 'right' },
  }
})
`,
  }} />
...
Renders a file avatarwith a name
