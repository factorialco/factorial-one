...
describe("getValueByPath", () => {
  ...
  describe("edge cases", () => {
    ...
    it("should handle null objects", () => {
      expect(getValueByPath(null as any, "a")).toBe(undefined)
      expect(getValueByPath(null as any, "a.b.c")).toBe(undefined)
    })

    it("should handle undefined objects", () => {
      expect(getValueByPath(undefined as any, "a")).toBe(undefined)
      expect(getValueByPath(undefined as any, "a.b.c")).toBe(undefined)
    })
