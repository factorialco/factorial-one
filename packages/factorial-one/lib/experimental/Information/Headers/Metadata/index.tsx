...
interface MetadataProps {
  /**
   * Everything that is not a MetadataItem is ignored.
   * Undefined and boolean are allowed to enable conditional items, e.g.
   * ```tsx
   * <Metadata items={[
   *   { label: "Label", value: { type: "text", content: "Value" } },
   *   canRead && { label: "Label", value: { type: "text", content: "Value" } },
   * ]} />
   * ```
   **/
